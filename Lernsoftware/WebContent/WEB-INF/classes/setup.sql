...
insert into T_LESSON (lessonid, title, chapter, content) values (3, 'Layer 2', 1, '<ol><li>Provides communication in the local (switched) network</li><li>Simple addressing scheme based on hardware identifiers</li></ol>');
