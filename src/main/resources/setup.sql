...
insert into T_LESSON (lessonid, title, chapter, content) values (6, 'Classful Addressing', 2, '<applet code="de.adv_boeblingen.seegerj.amed.lernsoftware.applets.SubnetApplet.class" codebase="../Applet/" width=450 height=350><param name="mode" value="class"></applet>');
insert into T_LESSON (lessonid, title, chapter, content) values (7, 'Classless Addressing', 2, '<applet code="de.adv_boeblingen.seegerj.amed.lernsoftware.applets.SubnetApplet.class" codebase="../Applet/" width=450 height=350><param name="mode" value="cidr"></applet>');
